...
<script type="text/javascript" src="http://localhost/jd/shop/Common/Js/jquery-1.11.3.min.js"></script>
    ...
    <body>
        ...
        <div></div>
                   <script type="text/javascript" charset="utf-8" src="http://localhost/jd/shop/plugin/ueditor/ueditor.config.js"></script>
            ...
            <script type="text/javascript" charset="utf-8" src="http://localhost/jd/shop/plugin/ueditor/ueditor.all.min.js"></script>
            <script type="text/javascript" charset="utf-8" src="http://localhost/jd/shop/plugin/ueditor/lang/zh-cn/zh-cn.js"></script>
            <script type="text/javascript" src="http://localhost/jd/shop/Common/Js/uploadPreview.js"></script>
    </head>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="/jd/shop/index.php/Back/Goods/upd/goods_id/16.html" method="post" enctype="multipart/form-data">
...
function add_sel(obj){
    ...
    select_num++;//计数器累加
                        ...
                        <td><input type="file" name="goods_logo_upd" />
                            <?php if(!empty($info["goods_big_logo"])): ?><img src='http://localhost/jd/shop/<?php echo ($info["goods_big_logo"]); ?>' width='200' height='200' alt=''/>
    <span>如果选择上传新的logo图片，则会自动覆盖旧图片</span><?php endif; ?></td>
                    </tr>
    ...
    obj.after(fu_obj); //把复制品tr 追加到页面
                ...
                <table border="1" width="100%" class="table_a" id="gallery-tab-tb"
                    ...
                    <tr>
                        <td colspan='100'>
                            <ul>
                            <?php if(is_array($picsinfo)): foreach($picsinfo as $key=>$v): ?><li id="pics_<?php echo ($v["id"]); ?>"><img src='http://localhost/jd/shop/<?php echo ($v["pics_big"]); ?>' alt='' width='100' height='100'/>
