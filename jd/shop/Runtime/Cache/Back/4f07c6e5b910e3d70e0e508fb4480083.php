...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="http://localhost/jd/shop/Back/Public/css/User_Login.css" type="text/css" rel="stylesheet" />
        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="/jd/shop/index.php/Back/Admin/login" method="post">
                        <ul>
                    ...
                    code_flag = false;
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="<?php echo U('VerifyImg');?>"  alt="验证码" onclick="this.src='/jd/shop/index.php/Back/Admin/verifyImg/'+Math.random()" />
                                        </li>
                                    </ul>
                                      <ul>
                            ...
                            <li class="user_main_r">
                                ...
                                <input style="border: medium none; background: url('http://localhost/jd/shop/Back/Public/img/user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                            </li>
                        </ul>
                    </form>
                          <script type="text/javascript">
