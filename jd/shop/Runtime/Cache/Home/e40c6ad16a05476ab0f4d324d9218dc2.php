 ...
 <h3><a href="<?php echo U('Goods/showlist',array('cat_id'=>$v['cat_id']));?>"><?php echo ($v["cat_name"]); ?></a> <b></b></h3>
	...
	<div class="colligate w1210 bc mt10">
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/index_slide1.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/index_slide2.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/index_slide3.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/index_slide4.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/index_slide5.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/index_slide6.jpg" alt="" /></a></li>
					</ul>
				</div>
		...
		<div class="coll_right fl ml10">
			<div class="ad"><a href=""><img src="http://localhost/jd/shop/Home/Public/images/ad.jpg" alt="" /></a></div>
			...
			<div class="service mt10">
				...
				<div class="service_wrap">
					...
					<div class="travel none">
						<ul>
							<li>
								<a href=""><img src="http://localhost/jd/shop/Home/Public/images/holiday.jpg" alt="" /></a>
								<a href="" class="button">度假查询</a>
							</li>
							<li>
								<a href=""><img src="http://localhost/jd/shop/Home/Public/images/scenic.jpg" alt="" /></a>
					...
					<div class="lottery none">
						<p><img src="http://localhost/jd/shop/Home/Public/images/lottery.jpg" alt="" /></p>
					</div>
					<!-- 彩票 end -->
					...
					<div class="game none">
						<ul>
							<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/sanguo.jpg" alt="" /></a></li>
							<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/taohua.jpg" alt="" /></a></li>
							<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/wulin.jpg" alt="" /></a></li>
						</ul>
					</div>
					<!-- 游戏 end -->
				</div>
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					...
					<?php if(is_array($info_qiang)): foreach($info_qiang as $key=>$v): ?><li>
						<dl>
							<dt><a href="<?php echo U('cart/goodsdetail',array('goods_id'=>$v['goods_id']));?>"><img src="http://localhost/jd/shop/<?php echo ($v["goods_big_logo"]); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('cart/goodsdetail',array('goods_id'=>$v['goods_id']));?>"><?php echo ($v["goods_name"]); ?></a></dd>
...
<!-- 推荐商品 atart -->
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="http://localhost/jd/shop/Home/Public/images/viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="http://localhost/jd/shop/Home/Public/images/samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					...
					<p><a href=""><img src="http://localhost/jd/shop/Home/Public/images/notebook.jpg" alt="" /></a></p>
				</div>
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							...
							<li>
								<dl>
									<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/thinkpad e420.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/acer4739.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/samsung6800.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/lh531.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/qinghuax2.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/dell.gif" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/acer.gif" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
			...
			<!-- 广告 start -->
			<div class="ads mt10">
				<a href=""><img src="http://localhost/jd/shop/Home/Public/images/canon.jpg" alt="" /></a>
			</div>
			<!-- 广告 end -->
		</div>
		<!-- 右侧 end -->
