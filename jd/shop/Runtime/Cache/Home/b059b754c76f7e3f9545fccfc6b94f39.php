...
<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/list.css" type="text/css">
<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/common.css" type="text/css">
<script type="text/javascript" src="http://localhost/jd/shop/Home/Public/js/list.js"></script>
		...
		<div class="newgoods leftbar mt10">
			...
			<div class="leftbar_wrap">
				<ul>
					<li>
						<dl>
							<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/list_hot1.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/list_hot2.jpg" alt="" /></a></dt>
					...
					<li class="last">
						<dl>
							<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/list_hot3.jpg" alt="" /></a></dt>
...
<?php if(is_array($info)): foreach($info as $key=>$v): ?><li>
	<dl>
	<dd><a href=""><?php echo ($v["goods_id"]); ?></a></dt>
