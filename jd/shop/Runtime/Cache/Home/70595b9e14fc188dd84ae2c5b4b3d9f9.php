...
<!--引入公共的jquery-->
	...
	<!-- 页面头部 end -->
        ...
        <
	<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/fillin.css" type="text/css">
	

	<script type="text/javascript" src="http://localhost/jd/shop/Home/Public/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="http://localhost/jd/shop/Home/Public/js/cart2.js"></script>
