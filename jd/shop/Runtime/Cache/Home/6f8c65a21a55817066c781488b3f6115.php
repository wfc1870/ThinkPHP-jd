...
<head>
	...
	<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/index.css" type="text/css">
	<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/bottomnav.css" type="text/css">
	<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/footer.css" type="text/css">

	<script type="text/javascript" src="http://localhost/jd/shop/Home/Public/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="http://localhost/jd/shop/Home/Public/js/header.js"></script>
	<script type="text/javascript" src="http://localhost/jd/shop/Home/Public/js/index.js"></script>
</head>
<body>
<!-- 顶部导航 start -->
<div class="topnav">
...
<!--引入公共的jquery-->
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="<?php echo U('Home/Index/index');?>"><img src="http://localhost/jd/shop/Home/Public/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
				...
				<dl>
					...
					<dd>
						...
						<div class="viewlist mt10">
							<h3>最近浏览的商品：</h3>
							<ul>
								<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/view_list1.jpg" alt="" /></a></li>
								<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/view_list2.jpg" alt="" /></a></li>
								<li><a href=""><img src="http://localhost/jd/shop/Home/Public/images/view_list3.jpg" alt="" /></a></li>
							</ul>
						</div>
					</dd>
				</dl>
...
<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/goods.css" type="text/css">
	<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/common.css" type="text/css">
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_left fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/relate_view5.jpg" alt="" /></a></dt>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					<dl>
						<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/hpG4.jpg" alt="" /></a></dt>
						<dd><a href="">惠普G4-1332TX 14英寸笔记...</a></dd>
					</dl>

					<dl class="last">
						<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/crazy4.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="http://localhost/jd/shop/Home/Public/images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://localhost/jd/shop/Home/Public/images/preview_m1.jpg" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m1.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l1.jpg'}"><img src="http://localhost/jd/shop/Home/Public/images/preview_s1.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m2.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l2.jpg'}"><img src="http://localhost/jd/shop/Home/Public/images/preview_s2.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m3.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l3.jpg'}">  
	    							<img src="http://localhost/jd/shop/Home/Public/images/preview_s3.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m4.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l4.jpg'}">  
	    							<img src="http://localhost/jd/shop/Home/Public/images/preview_s4.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m5.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l5.jpg'}">  
	    							<img src="http://localhost/jd/shop/Home/Public/images/preview_s5.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m6.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l6.jpg'}">  
	    							<img src="http://localhost/jd/shop/Home/Public/images/preview_s6.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m7.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l7.jpg'}">  
	    							<img src="http://localhost/jd/shop/Home/Public/images/preview_s7.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m8.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l8.jpg'}">  
	    							<img src="http://localhost/jd/shop/Home/Public/images/preview_s8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'http://localhost/jd/shop/Home/Public/images/preview_m9.jpg',largeimage: 'http://localhost/jd/shop/Home/Public/images/preview_l9.jpg'}">  
	    							<img src="http://localhost/jd/shop/Home/Public/images/preview_s9.jpg"></a>
								</li>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?php echo U('cart/mycart',array('goods_id'=>$v['goods_id']));?>" method="post" class="choose">
						<ul>
							<li class="product">
								<dl>
									<dt>颜色：</dt>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="http://localhost/jd/shop/Home/Public/images/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://localhost/jd/shop/Home/Public/images/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://localhost/jd/shop/Home/Public/images/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://localhost/jd/shop/Home/Public/images/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://localhost/jd/shop/Home/Public/images/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://localhost/jd/shop/Home/Public/images/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://localhost/jd/shop/Home/Public/images/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://localhost/jd/shop/Home/Public/images/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://localhost/jd/shop/Home/Public/images/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://localhost/jd/shop/Home/Public/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
