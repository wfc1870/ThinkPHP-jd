...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action="/jd/shop/index.php/Home/User/regist.html" method="post">
...
<li class="checkcode">
    ...
    <input type="text" id='verify_code' name="verify_code" maxlength='4'
     onkeyup='check_code()'/>
    <img src="<?php echo U('verifyImg');?>"  alt="验证码" onclick="this.src='/jd/shop/index.php/Home/User/verifyImg/'+Math.random()" />
