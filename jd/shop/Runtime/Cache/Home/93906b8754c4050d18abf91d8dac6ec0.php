...
<!--引入公共的jquery-->
	...
	<link rel="stylesheet" href="http://localhost/jd/shop/Home/Public/style/cart.css" type="text/css">


	<script type="text/javascript" src="http://localhost/jd/shop/Home/Public/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="http://localhost/jd/shop/Home/Public/js/cart1.js"></script>
...
<body>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<tbody>
				<tr>
					<td class="col1"><a href=""><img src="http://localhost/jd/shop/Home/Public/images/cart_goods1.jpg" alt="" /></a>  <strong><a href="">【1111购物狂欢节】惠JackJones杰克琼斯纯羊毛菱形格</a></strong></td>
					...
					<td class="col4"> 
						...
						<input type="text" name="amount" value="2" class="amount"/>
				...
				<tr>
					<td class="col1"><a href=""><img src="http://localhost/jd/shop/Home/Public/images/cart_goods2.jpg" alt="" /></a> <strong><a href="">九牧王王正品新款时尚休闲中长款茄克EK01357200</a></strong></td>
				...
				<tr>
					<td class="col1"><a href=""><img src="http://localhost/jd/shop/Home/Public/images/cart_goods3.jpg" alt="" /></a> <strong><a href="">【1111购物狂欢节】捷王纯手工缝制休闲男鞋大头皮鞋 头层牛</a></strong></td>
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="jiesuan" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
